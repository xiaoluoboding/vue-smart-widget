  ...
  >
    <div class="widget-header" :style="widgetHeaderHeight" v-if="!simple">
      ...
      <div class="widget-header__toolbar">
        ...
        <a
          href="javascript:;"
          v-if="!isHasGroup && collapse && !isFullScreen"
        ...
        >
          <template v-if="isCollapsed">
            ...
            >
              <path
                d="M917.333 364.8L851.2 298.667 512 637.867l-339.2-339.2-66.133 66.133L512 768z"
                fill="#666"
              />
            </svg>
          </template>
          <template v-else>
            ...
            >
              <path
                d="M106.667 659.2l66.133 66.133 339.2-339.2 339.2 339.2 66.133-66.133L512 256z"
                fill="#666"
              />
            </svg>
          </template>
        ...
        <a href="javascript:;" v-if="refresh && !isFullScreen">
          ...
          <template v-else>
            ...
            >
              <g fill="#666">
                <path
                  d="M14 8A6 6 0 0 0 3.372 4.18a.5.5 0 1 0 .771.638A5 5 0 0 1 13 8a.5.5 0 1 0 1 0zM2 8a6 6 0 0 0 10.549 3.912.5.5 0 1 0-.758-.652A5 5 0 0 1 3 8a.5.5 0 0 0-1 0z"
                />
                <path
                  d="M4 1.5V4h2.5a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5v-3a.5.5 0 0 1 1 0zm8 13v-2.502H9.5a.5.5 0 0 1 0-1h3a.5.5 0 0 1 .5.5V14.5a.5.5 0 1 1-1 0z"
                />
              </g>
            </svg>
          </template>
    ...
    <collapse-transition>
      ...
      >
        ...
        >
          <slot v-bind:contentH="contentH"></slot>
        </div>
        <!-- end widget content -->
        <!-- widget footer -->
        <div
          class="widget-body__footer"
          :class="{ 'has-group': isHasGroup }"
          ref="widgetBodyFooter"
        >
...
export default {
  ...
  computed: {
    ...
    bodyContentPadding() {
      const padding =
        typeof this.padding === 'number' ? Array.of(this.padding) : this.padding
  ...
  mounted() {
    this.$nextTick((_) => {
      ...
      this.widgetBodyEditBoxH = this.$slots.editbox
        ? this.$refs.widgetBodyEditbox.offsetHeight
        : 0
      this.widgetBodyFooterH = this.$slots.footer
        ? this.$refs.widgetBodyFooter.offsetHeight
        : 0
    })
  },
  methods: {
    handlefullScreen() {
      ...
      if (this.isFullScreen) {
        this.$nextTick((_) => {
          ...
          const widgetBodyOffsetHeight =
            document.body.offsetHeight - this.rowHeight
    ...
    getContentH() {
      ...
      const contentH =
        widgetBodyH - paddingH - widgetBodyEditBoxH - widgetBodyFooterH - 1
