<template>
  <div id="grid-wrapper">
    <h1 style="text-align: center">Vue Smart Widget</h1>
    <!--<pre>{{ layout | json }}</pre>-->
    <div>
...
<script>
import GridItem from '../../src/vue-grid-layout/GridItem.vue'
import GridLayout from '../../src/vue-grid-layout/GridLayout.vue'
import TestElement from '../../src/vue-grid-layout/TestElement.vue'
import CustomDragElement from '../../src/vue-grid-layout/CustomDragElement.vue'
import {
  getDocumentDir,
  setDocumentDir
} from '../../src/vue-grid-layout/helpers/dom'
